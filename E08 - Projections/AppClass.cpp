...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(Simplex::vector3(20, 10, 0));
		m_pCamera->SetUp(Simplex::vector3(0, 0, -1));
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(Simplex::vector3(0, 0, -15));
		m_pCamera->SetUp(Simplex::vector3(0, 1, 0));
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(Simplex::vector3(0, 0, -15));
		m_pCamera->SetNearFar(Simplex::vector2(5, 100));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPosition(Simplex::vector3(0, 0, -15));
		m_pCamera->SetNearFar(Simplex::vector2(1, 10));
		break;
	case 7:
		m_pCamera->ResetCamera();
		m_pCamera->SetUp(Simplex::vector3(0, -1, 0));
