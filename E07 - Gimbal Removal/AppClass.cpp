...
void Application::Display(void)
{
	...
	//5m_m4Model = glm::translate(IDENTITY_M4, vector3(1, 2, 3));
	...
	//static Simplex::quaternion qStart;
	//Simplex::quaternion q1 = glm::angleAxis(0.01f, vector3(0.0f, 1.0f, 0.0f));

	//qStart = qStart * q1;
	//m_pMesh->Render(m4Projection, m4View, ToMatrix4(qStart));
